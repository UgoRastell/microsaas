...
const Invoices = () => {
  ...
  const loadInvoices = async () => {
    ...
    try {
      ...
      // Grâce aux politiques RLS, seules les factures liées aux clients de l'utilisateur connecté seront retournées
      const { data, error } = await query
      
      if (error) throw error

      console.log(`${data?.length || 0} factures chargées via RLS`)
