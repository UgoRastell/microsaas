 ...
 * Invoice routes
 */
async function invoiceRoutes(fastify, _options) {
    /**
     * @swagger
     * /api/invoices:
     *   get:
    ...
    fastify.get('/', async (request, reply) => {
        try {
            ...
            const responsePromise = new Promise((resolve, reject) => {
                ...
                const subscription = (0, nats_1.subscribeToSubject)(`invoice.get.response.${requestId}`, (msg) => {
                    clearTimeout(timeout);
                    subscription.unsubscribe();
                    resolve(msg);
                });
                // Publish the request
                (0, nats_1.publishMessage)('invoice.get.request', {
                    requestId,
                    orgId,
                    filters: { status },
    ...
    fastify.post('/', async (request, reply) => {
        try {
            ...
            (0, nats_1.publishMessage)('invoice.create', invoice);
    ...
    fastify.post('/:id/send', async (request, reply) => {
        try {
            ...
            (0, nats_1.publishMessage)('invoice.send', {
                invoice_id: id,
    ...
    fastify.delete('/:id', async (request, reply) => {
        try {
            ...
            (0, nats_1.publishMessage)('invoice.delete', {
                invoice_id: id,
                organization_id: orgId
            });
            return {
